...
layout(binding = 3) buffer inputBuffer3 {float insideTrack[]; };
layout(binding = 4) buffer inputBuffer4 {float outsideTrack[]; };
layout(binding = 5) buffer outputBuffer2 {float carCollisions[]; };
