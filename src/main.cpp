...
void calculateFitness(void) {
    ...
    ncfLoc = glGetUniformLocation(fittnessComputeShader, "brakingForce");
    glUniform1f(ncfLoc, breakingForce);
    ncfLoc = glGetUniformLocation(fittnessComputeShader, "mass");
    glUniform1f(ncfLoc, carMass);
